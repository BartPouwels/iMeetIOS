...
class QRScannerViewController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if (segue.identifier == "ReverseQRScannerSegue") {
            ...
            destination.receivedID = sendID as String
        }
    }
    ...
    func launchApp() {
        ...
        performSegue(withIdentifier: "ReverseQRScannerSegue", sender: self)
    }
...
extension QRScannerViewController: AVCaptureMetadataOutputObjectsDelegate {
    ...
    func metadataOutput(_ output: AVCaptureMetadataOutput, didOutput metadataObjects: [AVMetadataObject], from connection: AVCaptureConnection) {
        ...
        if metadataObjects.count == 0 {
            ...
            messageLabel.text = "Scan bezoekerskaart"
            return
        }
        ...
        if supportedCodeTypes.contains(metadataObj.type) {
            ...
            if metadataObj.stringValue != nil {
                sendID = metadataObj.stringValue!
